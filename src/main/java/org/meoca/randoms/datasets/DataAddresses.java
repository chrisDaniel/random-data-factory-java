package org.meoca.randoms.datasets;

import java.util.function.Supplier;

public interface DataAddresses{

    String[] streetNames = { "Aberdeen", "Abington", "Academy",
    ...
    String[] streetSuffixes = { "Avenue", "Boulevard",
    ...
    String[] cities = { "Abba", "Abbeville", "Acworth",
